...
namespace Veterinaria.MAUIApp.Services
{
        public class TratamientoService
        {
            ...
            private const string endpoint = "api/tratamientos";
        ...
        {
            // Backend: PATCH /api/tratamientos/{id}/activar?activo=true|false
            var url = $"api/tratamientos/{id}/activar?activo={(activo ? "true" : "false")}";
