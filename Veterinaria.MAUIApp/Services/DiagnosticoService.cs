...
namespace Veterinaria.MAUIApp.Services
{
    public class DiagnosticoService
    {
        ...
        {
            var response = await _http.PostAsJsonAsync($"api/citas/{citaId}/diagnosticos", diagnostico);
        ...
        {
            await _http.PutAsJsonAsync($"api/citas/{citaId}/diagnosticos/{id}", diagnostico);
        }
        ...
        public async Task CambiarEstadoAsync(long citaId, long id, bool estado)
        {
            await _http.PatchAsync(
                $"api/citas/{citaId}/diagnosticos/{id}/estado?activo={estado}",
                null
            );
        }
    }
